#ifndef XC32LIB_SFR_TIMER3_INC
#define XC32LIB_SFR_TIMER3_INC 100
#
/*=====timer3=====*/
...
#	define XC32LIB_TIMER3_IRQ 12
#	define XC32LIB_TIMER3_VEC 12
#	define XC32LIB_TIMER3_IF IFS0bits.T3IF
#	define XC32LIB_TIMER3_IE IEC0bits.T3IE
#	define XC32LIB_TIMER3_IP IPC3bits.T3IP
#	define XC32LIB_TIMER3_IS IPC3bits.T3IS
#elif defined(XC32LIB_PIC32MZ)
#	define XC32LIB_TIMER3_IRQ 14
#	define XC32LIB_TIMER3_VEC _TIMER_3_VECTOR
#	define XC32LIB_TIMER3_IF IFS0bits.T3IF
#	define XC32LIB_TIMER3_IE IEC0bits.T3IE
#	define XC32LIB_TIMER3_IP IPC3bits.T3IP
#	define XC32LIB_TIMER3_IS IPC3bits.T3IS
...
#ifndef XC32LIB_SFR_TIMER3_EXPLICITINTERRUPT
#	ifndef XC32LIB_DEBUGMODE
#		define x_xc32_sfr_timer3_interrupt(void) __ISR(XC32LIB_TIMER3_VEC, XC32LIB_TIMER3_IPL_FOR_ISR) T3Interrupt(void)//*/func(void)
#	else
extern "C"{void x_xc32_sfr_timer3_interrupt(void); }
#	endif
#else
#	ifndef XC32LIB_DEBUGMODE
#		define xc32_sfr_timer3_interrupt(void) __ISR(XC32LIB_TIMER3_VEC, XC32LIB_TIMER3_IPL_FOR_ISR) T3Interrupt(void)//*/func(void)
#	else
...
namespace xc32{
	namespace sfr{
		...
		public:
			...
			void interrupt_flag(bool val_){XC32LIB_TIMER3_IF=static_cast<unsigned char>(val_);}
			bool interrupt_flag()const {return static_cast<bool>(XC32LIB_TIMER3_IF);}
			//interrupt enable bit : IECxbits.I2CxMIE
			void interrupt_enable(bool val_){XC32LIB_TIMER3_IE=static_cast<unsigned char>(val_);}
			bool interrupt_enable()const{return static_cast<bool>(XC32LIB_TIMER3_IE);}
			//Interrupt priority level : IPCxbits.I2CxIP
			void interrupt_priority_level(unsigned char val_){XC32LIB_TIMER3_IP=val_;}
			unsigned char interrupt_priority_level(){return XC32LIB_TIMER3_IP;}
			//Interrupt priority level : IPCxbits.I2CxIP
			void interrupt_sub_priority_level(unsigned char val_){XC32LIB_TIMER3_IS=val_;}
			unsigned char interrupt_sub_priority_level(){return XC32LIB_TIMER3_IS;}
