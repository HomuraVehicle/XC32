#ifndef XC32_SFR_TIMER2_INC
#define XC32_SFR_TIMER2_INC 100
#
/*=====timer2=====*/
...
#	define XC32_TIMER2_IRQ 8
#	define XC32_TIMER2_VEC 8
#	define XC32_TIMER2_IF IFS0bits.T2IF
#	define XC32_TIMER2_IE IEC0bits.T2IE
#	define XC32_TIMER2_IP IPC2bits.T2IP
#	define XC32_TIMER2_IS IPC2bits.T2IS
#elif defined(XC32_PIC32MZ)
#	define XC32_TIMER2_IRQ 9
#	define XC32_TIMER2_VEC _TIMER_2_VECTOR
#	define XC32_TIMER2_IF IFS0bits.T2IF
#	define XC32_TIMER2_IE IEC0bits.T2IE
#	define XC32_TIMER2_IP IPC2bits.T2IP
#	define XC32_TIMER2_IS IPC2bits.T2IS
...
#		define x_xc32_sfr_timer2_interrupt(void) __ISR(XC32_TIMER2_VEC, XC32_TIMER2_IPL_FOR_ISR) T2Interrupt(void)//*/func(void)
#	else
extern "C"{void x_xc32_sfr_timer2_interrupt(void); }
#	endif
#else
#	ifndef XC32_DEBUGMODE
#		define xc32_sfr_timer2_interrupt(void) __ISR(XC32_TIMER2_VEC, XC32_TIMER2_IPL_FOR_ISR) T2Interrupt(void)//*/func(void)
#	else
...
namespace xc32{
	...
	namespace sfr{
		...
		public:
			...
			void interrupt_flag(bool val_){XC32_TIMER2_IF=static_cast<unsigned char>(val_);}
			bool interrupt_flag()const {return static_cast<bool>(XC32_TIMER2_IF);}
			//interrupt enable bit : IECxbits.I2CxMIE
			void interrupt_enable(bool val_){XC32_TIMER2_IE=static_cast<unsigned char>(val_);}
			bool interrupt_enable()const{return static_cast<bool>(XC32_TIMER2_IE);}
			//Interrupt priority level : IPCxbits.I2CxIP
			void interrupt_priority_level(unsigned char val_){XC32_TIMER2_IP=val_;}
			unsigned char interrupt_priority_level(){return XC32_TIMER2_IP;}
			//Interrupt priority level : IPCxbits.I2CxIP
			void interrupt_sub_priority_level(unsigned char val_){XC32_TIMER2_IS=val_;}
			unsigned char interrupt_sub_priority_level(){return XC32_TIMER2_IS;}
