#ifndef XC32LIB_SFR_UART4_CPP_INC
#define XC32LIB_SFR_UART4_CPP_INC 100
#
#include"uart4.hpp"
...
namespace xc32{
	namespace sfr{
		...
		const unsigned char uart4::tx_ipl = XC32LIB_UART4_TX_IPL;
		const unsigned char uart4::rx_ipl = XC32LIB_UART4_RX_IPL;
	}
}
