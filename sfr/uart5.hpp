#ifndef XC32_SFR_UART5_INC
#define XC32_SFR_UART5_INC 101
#
/*=== uart5 ===
新型割り込み関数名に変更
...
#	define XC32_UART5_TX_IRQ 75
#	define XC32_UART5_RX_IRQ 74
#	define XC32_UART5_VEC 51
#	define XC32_UART5_TX_IF IFS2bits.U5TXIF
#	define XC32_UART5_TX_IE IEC2bits.U5TXIE
#	define XC32_UART5_TX_IP IPC12bits.U5IP
#	define XC32_UART5_TX_IS IPC12bits.U5IS
#	define XC32_UART5_RX_IF IFS2bits.U5RXIF
#	define XC32_UART5_RX_IE IEC2bits.U5RXIE
#	define XC32_UART5_RX_IP IPC12bits.U5IP
#	define XC32_UART5_RX_IS IPC12bits.U5IS
#elif defined(XC32_PIC32MZ)
#	define XC32_UART5_TX_IRQ 181
#	define XC32_UART5_TX_VEC _UART5_TX_VECTOR
#	define XC32_UART5_TX_IF IFS5bits.U5TXIF
#	define XC32_UART5_TX_IE IEC5bits.U5TXIE
#	define XC32_UART5_TX_IP IPC45bits.U5TXIP
#	define XC32_UART5_TX_IS IPC45bits.U5TXIS
#	define XC32_UART5_RX_IRQ 180
#	define XC32_UART5_RX_VEC _UART5_RX_VECTOR
#	define XC32_UART5_RX_IF IFS5bits.U5RXIF
#	define XC32_UART5_RX_IE IEC5bits.U5RXIE
#	define XC32_UART5_RX_IP IPC45bits.U5RXIP
#	define XC32_UART5_RX_IS IPC45bits.U5RXIS
#else
...
#			define x_xc32_sfr_uart5_interrupt(void) __ISR(XC32_UART5_VEC, IPL7AUTO) U5Interrupt(void)//*/func(void)
#		else
extern "C"{void x_xc32_sfr_uart5_interrupt(void); }
#		endif
#	else
#		ifndef XC32_DEBUGMODE
#			define xc32_sfr_uart5_interrupt(void) __ISR(XC32_UART5_VEC, IPL7AUTO) U5Interrupt(void)//*/func(void)
#		else
...
#	ifndef XC32_SFR_UART5_EXPLICITINTERRUPT
#		ifndef XC32_DEBUGMODE
#			define x_xc32_sfr_uart5_tx_interrupt(void) __ISR(XC32_UART5_TX_VEC, XC32_UART5_TX_IPL_FOR_ISR) U5TXInterrupt(void)//*/func(void)
#			define x_xc32_sfr_uart5_rx_interrupt(void) __ISR(XC32_UART5_RX_VEC, XC32_UART5_RX_IPL_FOR_ISR) U5RXInterrupt(void)//*/func(void)
#		else
extern "C"{void x_xc32_sfr_uart5_tx_interrupt(void); void x_xc32_sfr_uart5_rx_interrupt(void); }
#		endif
#	else
#		ifndef XC32_DEBUGMODE
#			define xc32_sfr_uart5_tx_interrupt(void) __ISR(XC32_UART5_TX_VEC, XC32_UART5_TX_IPL_FOR_ISR) U5TXInterrupt(void)//*/func(void)
#			define xc32_sfr_uart5_rx_interrupt(void) __ISR(XC32_UART5_RX_VEC, XC32_UART5_RX_IPL_FOR_ISR) U5RXInterrupt(void)//*/func(void)
#		else
...
namespace xc32{
	namespace sfr{
		...
		public:
			...
			void rx_interrupt_enable(bool val_){XC32_UART5_RX_IE=static_cast<unsigned char>(val_);}
			bool rx_interrupt_enable()const{return static_cast<bool>(XC32_UART5_RX_IE);}
			//Receive Interrupt Flag bit : IFSxbits.UxRXIF
			void rx_interrupt_flag(bool val_){XC32_UART5_RX_IF=static_cast<unsigned char>(val_);}
			bool rx_interrupt_flag()const {return static_cast<bool>(XC32_UART5_RX_IF);}
			//Interrupt priority level : IPCxbits.UxIP
			void rx_interrupt_priority_level(unsigned char val_){XC32_UART5_RX_IP=val_;}
			unsigned char rx_interrupt_priority_level(){return XC32_UART5_RX_IP;}
			//Interrupt priority level : IPCxbits.UxIP
			void rx_interrupt_sub_priority_level(unsigned char val_){XC32_UART5_RX_IS=val_;}
			unsigned char rx_interrupt_sub_priority_level(){return XC32_UART5_RX_IS;}
			//Transmit Interrupt Enable bit : IECxbits.UxTXIE
			void tx_interrupt_enable(bool val_){XC32_UART5_TX_IE=static_cast<unsigned char>(val_);}
			bool tx_interrupt_enable()const{return static_cast<bool>(XC32_UART5_TX_IE);}
			//Transmit Interrupt Flag : IFSxbits.UxTXIF
			void tx_interrupt_flag(bool val_){XC32_UART5_TX_IF=static_cast<unsigned char>(val_);}
			bool tx_interrupt_flag()const {return static_cast<bool>(XC32_UART5_TX_IF);}
			//Interrupt priority level : IPCxbits.UxIP
			void tx_interrupt_priority_level(unsigned char val_){XC32_UART5_TX_IP=val_;}
			unsigned char tx_interrupt_priority_level(){return XC32_UART5_TX_IP;}
			//Interrupt priority level : IPCxbits.UxIP
			void tx_interrupt_sub_priority_level(unsigned char val_){XC32_UART5_TX_IS=val_;}
			unsigned char tx_interrupt_sub_priority_level(){return XC32_UART5_TX_IS;}
