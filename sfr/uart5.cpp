#ifndef XC32LIB_SFR_UART5_CPP_INC
#define XC32LIB_SFR_UART5_CPP_INC 100
#
#include"uart5.hpp"
...
namespace xc32{
	namespace sfr{
		...
		const unsigned char uart5::tx_ipl = XC32LIB_UART5_TX_IPL;
		const unsigned char uart5::rx_ipl = XC32LIB_UART5_RX_IPL;
	}
}
