#ifndef XC32_SFR_UART3_CPP_INC
#define XC32_SFR_UART3_CPP_INC 100
#
#include"uart3.hpp"
...
namespace xc32{
	namespace sfr{
		...
		const unsigned char uart3::tx_ipl = XC32_UART3_TX_IPL;
		const unsigned char uart3::rx_ipl = XC32_UART3_RX_IPL;
	}
}
