#ifndef XC32LIB_SFR_TIMER6_INC
#define XC32LIB_SFR_TIMER6_INC 100
#
/*=====timer6=====*/
...
#	define XC32LIB_TIMER6_IRQ 28
#	define XC32LIB_TIMER6_VEC _TIMER_6_VECTOR
#	define XC32LIB_TIMER6_IF IFS0bits.T6IF
#	define XC32LIB_TIMER6_IE IEC0bits.T6IE
#	define XC32LIB_TIMER6_IP IPC7bits.T6IP
#	define XC32LIB_TIMER6_IS IPC7bits.T6IS
#else
#	error Unknown device!
#endif

#ifndef XC32LIB_SFR_TIMER6_EXPLICITINTERRUPT
#	ifndef XC32LIB_DEBUGMODE
#		define x_xc32_sfr_timer6_interrupt(void) __ISR(XC32LIB_TIMER6_VEC, XC32LIB_TIMER6_IPL_FOR_ISR) T6Interrupt(void)//*/func(void)
#	else
extern "C"{void x_xc32_sfr_timer6_interrupt(void); }
#	endif
#else
#	ifndef XC32LIB_DEBUGMODE
#		define xc32_sfr_timer6_interrupt(void) __ISR(XC32LIB_TIMER6_VEC, XC32LIB_TIMER6_IPL_FOR_ISR) T6Interrupt(void)//*/func(void)
#	else
...
namespace xc32{
	namespace sfr{
		...
		public:
			...
			void interrupt_flag(bool val_){XC32LIB_TIMER6_IF=static_cast<unsigned char>(val_);}
			bool interrupt_flag()const {return static_cast<bool>(XC32LIB_TIMER6_IF);}
			//interrupt enable bit : IECxbits.I2CxMIE
			void interrupt_enable(bool val_){XC32LIB_TIMER6_IE=static_cast<unsigned char>(val_);}
			bool interrupt_enable()const{return static_cast<bool>(XC32LIB_TIMER6_IE);}
			//Interrupt priority level : IPCxbits.I2CxIP
			void interrupt_priority_level(unsigned char val_){XC32LIB_TIMER6_IP=val_;}
			unsigned char interrupt_priority_level(){return XC32LIB_TIMER6_IP;}
			//Interrupt priority level : IPCxbits.I2CxIP
			void interrupt_sub_priority_level(unsigned char val_){XC32LIB_TIMER6_IS=val_;}
			unsigned char interrupt_sub_priority_level(){return XC32LIB_TIMER6_IS;}
			...
			void reset_all_config(){
				T6CON &= 0x00010000;			//ONˆÈŠO‚ð0‚ÅƒtƒBƒ‹
